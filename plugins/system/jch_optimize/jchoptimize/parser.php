...
URLREGEX;
        ...
        {
                $s1 = Optimize::DOUBLE_QUOTE_STRING;
                $s2 = Optimize::SINGLE_QUOTE_STRING;
                $b  = Optimize::BLOCK_COMMENTS;
                $c  = Optimize::LINE_COMMENTS;
        ...
        public function getCssRegex()
        {
                ...
                $aRegex[3] = '[^>]*+>)';
                $aRegex[4] = "|(?:<style(?:(?!(?:type=(?![\"']?text/css))|(?:scoped))[^>])*>((?><?[^'\"/<]+(?>$s1|$s2|$b|$c|['\"/])?)*?)</[a-z0-9]++>)";
