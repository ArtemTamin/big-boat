...
?>
	...
	public static function productsTemplate($products, $params)
	{
		...
		?>
			<div data3 class="block_product span3 <?php echo $params->get('products_class_sfx'); ?>" style="margin-left: 0; margin-bottom: 25px; margin-right: 20px;">
				<div class="product">
					...
					<div class="mainblock">
						...
						<p align="left" style="margin-left: 15px; color:#2a3950; text-decoration: underline;">
							<span style="font-size: x-large; height: 27px;" class="product_title ">
						...
						<div <? if (count($product->extra_field) > 0) { ?> class="exper" <? } ?>>
