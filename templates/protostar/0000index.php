...
// Add Stylesheets
$doc->addStyleSheetVersion($this->baseurl . '/templates/' . $this->template . '/css/template.css?22102020');
	...
	<div class="body">
      ...
      <!--Позиция phoneNumber -->
            ...
            <div class="phoneNumber" >
                   	<div class="ct_phone" style="font-size:xx-large; margin-top: 10px;"><a href="tel:88002508076">8-800-250-80-76</a></div>
    				<div style="font-size:medium;padding-top: 0px;margin-top: 20px">Бесплатные звонки по России</div>
            </div>
            </div>
