...
<div class="filter-carts">
	<div class="filter-button">
		<span>Фильтр</span>
		<div class="filter-img">
			<img src="/images/social-img/Group.png">
		</div>
	</div>
	
<form class="form-sort" action="<?php echo $this->action;?>" method="post" name="sort_count" id="sort_count">
<?php if ($this->config->show_sort_product || $this->config->show_count_select_products){?>
    ...
    <?php if ($this->config->show_sort_product){?>
        <span class="span6 box_products_sorting"><?php echo $this->sorting?>
			<!-- <img src="<?/*php echo $this->path_image_sorting_dir*/?>" alt="orderby" onclick="submitListProductFilterSortDirection()" /> -->
		</span>
    <?php }?>
