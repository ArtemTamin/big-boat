...
<div class="jshop productfull">
    <form name="product" method="post" action="<?php print $this->action?>" enctype="multipart/form-data" autocomplete="off">
        ...
        <!-- row-fluid -->
        <div class="row-fluid info-product">
            <!-- span5 -->
            <div class="span5">
            ...
            <div class="span7">
                ...
                <h1 class="title-card-product"><?php print $this->product->name?>
                ...
                <?php if ($this->product->_display_price){?>
                    <div class="prod_price">
                        ...
                        <div class="price-info">В цену товара не включена стоимость доставки</div>
                    </div>
                <?php }?>
                            ...
                            <?php foreach($this->attributes as $attribut){?>
                                <li class="row-fluid attributes_<?php print $attribut->attr_id?>">
                                    <label class="span4 attributes_title">
                                        <span dadadata class="attributes_name"><?php print $attribut->attr_name?>:</span>
                                    </label>
            	...
            	<span class="qty_from" <?php if ($add_price->product_quantity_finish==0){?>class="collspan3"<?php } ?>>
                    ...
                    <!--<div class="spoiler">
                     <label>
                         <input type="checkbox"/>
                         <span class="btn rassrochka">Оформить рассрочку</span>
                         <div class="text">
        ...
        <div class="tabs__nav tabs-nav">
            ...
            <div class="tabs-nav__item" data-tab-name="overview">Обзор</div>
            <div class="tabs-nav__item" data-tab-name="rev">Отзывы</div>
        </div>
        ...
        <div class="tabs__content">
            ...
            <div class="tab description">Описание</div>
            <div class="tab overview">
                <?php if (($flag==0) and (strcmp($this->product->description,'')!=0)){ ?>
                    <div  id="specs">
                        <div class="jshop_prod_description">
                            <?php print $this->product->description; $flag=1;?>
                        </div>
                    </div>
                <?php }?>
            </div>
    ...
    <!----------------------------------- Tab (дополнительно оборудование) ------------------------------------->
    <ul class="nav nav-tabs-card">
        <?php if (count($this->related_prod)){?>
            <li class="active"><h3><?php echo _JSHOP_RELATEDPR ?></h3></li>
        <?php }?>
    </ul>
