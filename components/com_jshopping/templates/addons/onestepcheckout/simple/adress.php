...
<div class="jshop address_block clearfix">
    ...
    <div class="jshop_js_register">
		...
		?>
		<div class="js-block-adress-fields" id="tr_field_<?php echo $v ?>" <?php echo $style ?>>
			...
			<div class="os-value">
				...
				<?php } else if ($v=='email') { ?>
				<span id="requiredemail" class="requiredtext text-error text-large js-hidden" rel="tooltip"  title="<?php echo JText::_('JSHOP_ONESTEPCHECKOUT_REQUIRED') ?>">
					<i class="icon-warning"></i>
				</span>
				<?php } ?>
			</div>
	...
	<?php if ($this->count_filed_delivery > 0){?>
			<div class="js-block-adress-fields">
				<?php if (!$this->addonParams->placeholder) { ?>
				<div data-2 class="os-name">
