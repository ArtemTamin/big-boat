...
<?php if ($this->allow_review){?>
   ...
   <?php if ($this->allow_review > 0){?>
        ...
        <form id="review-form" action="<?php print SEFLink('index.php?option=com_jshopping&controller=product&task=reviewsave');?>" name="add_review" method="post" onsubmit="return validateReviewForm(this.name)">
			...
			<div id="jshop_review_write" >
				...
				<!--<div >
					<label>
						Имя Гагарина?<br>(4 буквы)
					</label>
					<span>
						<input type="text" name="testhum"   class="inputbox" value="" />
					</span>
				</div>-->
