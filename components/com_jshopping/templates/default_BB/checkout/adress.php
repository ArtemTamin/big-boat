...
<div class="address__text-info">Для окончательного оформления Вашего заказа необходимо заполнить ниже представленную форму. По указанным
  контактным данным с Вами свяжется наш менеджер и поможет в подборе подходящей транспортной компании и
  сообщит его общую стоимость.
</div>
    <div data-test class="jshop_register user_info">
    <fieldset class="checkout_otstup">
		...
		<div class="control-group">
			<label class="control-label">
            	<?php echo _JSHOP_CITY . " доставки" ?> <?php if ($config_fields['city']['require']){?><span>*</span><?php } ?>
			</label>
			<span class="input">
		...
		<div class="control-group">
			...
			<script>
				$("#mobil_phone").mask("+7(999) 999-9999");
			</script>
		</div>
        <?php } ?>
    ...
    <fieldset class="checkout_otstup">
        ...
        <?php if ($config_fields['d_l_name']['require']){?>
		<div class="control-group">
			<label class="control-label">
