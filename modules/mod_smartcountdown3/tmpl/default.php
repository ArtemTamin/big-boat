...
<style>
	.scd-unit-vert {
		margin: <?php echo $layout['units_spacing_vert'] != '' ? $layout['units_spacing_vert'] :  '0.5em 0'; ?>;
	}
	.scd-unit-horz {
		margin: <?php echo $layout['units_spacing_horz'] != '' ? $layout['units_spacing_horz'] :  '0 0.8em'; ?>;
	}
</style>
